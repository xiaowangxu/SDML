...
// BITMASKS = [pos	, rot	, scale , fov	, near	, far	, name      , children	]
...
class SDML_THREE_PerspectiveCamera extends SDML_Compiler_Visitor {
    constructor(scope, name, id, parent, ast) {
        super(scope, name, id, parent, ast, TypesManagerSingleton.param('perspectivecamera'), ['pos', 'rot', 'scale', 'fov', 'near', 'far', 'name']);
    }
